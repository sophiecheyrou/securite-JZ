const CACHE='alerte-jz-v12-comptes-individuels';
const ASSETS=['./','./index.html','./styles.css?v=11-3','./app.js?v=11-3','./rooms-data.js?v=11-3','./rooms.json','./config.js?v=11-3','./manifest.webmanifest','./logo-jean-zay.jpg'];
