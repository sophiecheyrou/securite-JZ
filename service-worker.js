const CACHE='alerte-jz-v11-2-correctifs';
const ASSETS=['./','./index.html','./styles.css?v=11-2','./app.js?v=11-2','./rooms-data.js?v=11-2','./rooms.json','./config.js?v=11-2','./manifest.webmanifest','./logo-jean-zay.jpg'];
