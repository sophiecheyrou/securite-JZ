const CACHE='alerte-jz-v11-1-compte-unique';
const ASSETS=['./','./index.html','./styles.css?v=11-1','./app.js?v=11-1','./rooms-data.js?v=11-1','./rooms.json','./config.js?v=11-1','./manifest.webmanifest'];
