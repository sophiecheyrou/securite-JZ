const CACHE='alerte-jz-v10-multiutilisateurs';
const ASSETS=['./','./index.html','./styles.css?v=10','./app.js?v=10','./rooms-data.js?v=10','./rooms.json','./config.js?v=10','./manifest.webmanifest'];
